...
/* package cabal-study-0.1.0.0 */
#ifndef VERSION_cabal_study
#define VERSION_cabal_study "0.1.0.0"
#endif /* VERSION_cabal_study */
#ifndef MIN_VERSION_cabal_study
#define MIN_VERSION_cabal_study(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cabal_study */
...
#define CURRENT_COMPONENT_ID "cabal-study-0.1.0.0-inplace-cabal-study"
